    ...
    <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 justify-between "> 
       ...
       {Links.map((link,index)=>(
        ...
        { text.name }
         ...
         <div className="pb-3.5 sm:pd-0 col-span-1 md:col-span-2 lg:col-span-3">
          <Link to='/'>
              <img src="/src/imgs/logo.png" className="w-2/4 object-contain h-12 " />
           </Link>
           <p className="leading-7 text-sm text-border mt-3">
           <span>I am doaa abdelhai Frontend developer|React.js|, I am from Egypt </span>
           <br/>
           <span> Till: +2001285765185 </span>
           <br/>
           <span> Email: doaaapdelhai@gmail.com </span>
            </p>
          </div> 
